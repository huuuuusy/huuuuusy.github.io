...
Moreover, we are actively expanding the scope of visual language tracking task and exploring the potential development directions from the standpoint of human-machine interaction. We hope to leverage the capabilities of Large Language Models (LLMs) and construct more interactive dynamic visual algorithms.
